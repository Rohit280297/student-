Arguments: 
  /Users/petecook/.nvm/versions/node/v9.10.0/bin/node /usr/local/Cellar/yarn/1.5.1_1/libexec/bin/yarn.js test --verbose --serial
...
Trace: 
  ...
  Exit code: 1
  Command: sh
  Arguments: -c cross-env NODE_ENV=test ava --verbose --serial
